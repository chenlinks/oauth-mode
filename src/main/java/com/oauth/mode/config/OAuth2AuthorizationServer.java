...
public class OAuth2AuthorizationServer  extends AuthorizationServerConfigurerAdapter {
    ...
    /**
     *
     * 配置授权服务器的安全性，实际上是指/oauth/token端点。/oauth/authorize端点也需要安全，
    ...
    /**
     * 配置{@link ClientDetails​​ervice}，例如声明单个客户及其属性。
    ...
    public static void main(String[] args) {
        System.out.println(new BCryptPasswordEncoder().encode("chenling"));
    }
}
